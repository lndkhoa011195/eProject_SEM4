            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">${noteInsertSubCatePage}</h1>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT SUBCATEGORY</h1>
                                </div>

                                <form class="user" action="subCateServlet?action=insert" method="POST">


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Subcategory name:</span>
                                        <input type="text" name="subCateName" pattern=".{0,30}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name SubCategory..." style="width:83%">
                                    </div>


                                     <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Select category:</span>                                          
                                        <select id="selectCate" required="true" name="selectCate" class="form-control" style="width:83%">
