                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT CUSTOMER</h1>
                                </div>

                                <form class="user" action="customerServlet?action=insert" onsubmit = "return validateForm()" method="POST">


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Customer's name:</span><input type="text" name="cusName"  pattern="[a-zA-Z ]{0,50}" maxlength="50" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Customer..." style="width:83%">
                                    </div>
                                    
                                    <div class="form-group row">
                                         <span style="font-weight: bold;width: 17%; margin:auto">Customer's email:</span><input type="email" name="cusEmail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Customer..." style="width:83%">
                                    </div>
                                    
                                    <div class="form-group row">
                                         <span style="font-weight: bold;width: 17%; margin:auto">Customer's phone:</span><input type="tel" name="cusPhone"   pattern="[0-9]{1}[1-9]{1}[0-9]{8,11}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Phone Customer..." style="width:83%">
                                    </div>
                                    
                                    <div class="form-group row">
                                         <span style="font-weight: bold;width: 17%; margin:auto">Customer's address:</span><input type="text" name="cusAddress" pattern=".{0,200}" maxlength="100" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Address Customer..." style="width:83%">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Password:</span><input type="password" id="cusPass"  name="cusPass" required="true" value=""  class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Pass first..." style="width:83%">
                                    </div>
                                    
                                    <div class="form-group row">
                                         <span style="font-weight: bold;width: 17%; margin:auto">Confirm password:</span><input type="password" id="cusPass2" name="cusPass2" required="true" value="" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Pass Second..." style="width:83%">
                                    </div>
