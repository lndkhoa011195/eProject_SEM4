                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4"><p style="color: red">${noteLoginPage}</p></h1>
                                        ...
                                        <form class="user" action="loginServlet" method="POST">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="user" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Username...">
                                            </div>
