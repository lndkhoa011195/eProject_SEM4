                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight:bold">UPDATE DETAIL PRODUCT</h1>
                                </div>

                                <form class="user" action="productServlet?action=update" onsubmit = "return validateForm()" enctype="multipart/form-data" method="POST">


                                    <input id="noteIsAc" name="noteIsAc" hidden="true" value="${noteIsAc}"/>

                                    <div class="form-group">
                                        <input type="text" id="prdID" name="prdID"  value="${d.id}" hidden="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID Prodcut...">
                                    </div>

                                    <div class="form-group row">
                                         <span style="font-weight: bold;width: 15%; margin:auto">Product name:</span>
                                        <input type="text" id="prdName" required="true"  pattern=".{0,50}"accept=""name="prdName" value="${d.name}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Product..." style="width:85%">
                                    </div>
                                    ...
                                    <script language="javascript">
                                        document.getElementById(${d.categoryId.id}).selected = true;
                                    </script>
                                    ...
                                    <script language="javascript">
                                        function cateChanged(obj)
                                        {
                                            ...
                                            window.location = "productServlet?action=addSubCate2&&prdCate=" + cate + "&&prdUnit=" + unit + "&&prdManu=" + manu + "&&prdName=" + name + "&&prdOPrice=" + oPrice + "&&prdSPrice=" + sPrice + "&&prdDec=" + dec + "&&prdMade=" + made + "&&prdIsAc=" + active + "&&prdID=" + id;
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select id="prdSubCate" required="true" class="form-control" name="prdSubCate" style="width:85%">
                                            <c:forEach items="${listSubCate}" var="row3">       
                                                <c:choose>
                                                    <c:when test="${row3.id==d.subCategoryId.id}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select id="prdUnit" required="true" class="form-control" name="prdUnit" style="width:85%">
                                            <c:forEach items="${listUnit}" var="row3">       
                                                <c:choose>
                                                    <c:when test="${row3.id==d.unitId.id}">
                                                        <option id="${row3.id}" value="${row3.id}" selected="true" >${row3.name}</option>
                                                    </c:when>  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select id="prdManu" required="true" class="form-control" name="prdManu" style="width:85%">
                                            <c:forEach items="${listManu}" var="row4">       
                                                <c:choose>
                                                    <c:when test="${row4.id==d.manufacturerId.id}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" name="prdOPrice"  pattern="[0-9]{0,9}" required="true" value="${d.originalPrice}"  class="form-control" id="prdOPrice" aria-describedby="emailHelp" placeholder="Enter Original Price Product..." style="width:85%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Sale price:</span>
                                        <input type="number" name="prdSPrice"  pattern="[0-9]{0,9}" required="true" value="${d.sellingPrice}"  class="form-control" id="prdSPrice" aria-describedby="emailHelp" placeholder="Enter Selling Price Product..." style="width:85%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Description:</span>
                                        <input type="text" name="prdDec"  pattern=".{0,200}" accept=""value="${d.description}"  class="form-control" id="prdDec" aria-describedby="emailHelp" placeholder="Enter Desciption Product..." style="width:85%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Made in:</span>
                                        <input type="text" name="prdMade" pattern=".{0,50}" value="${d.madeIn}"  class="form-control" id="prdMade" aria-describedby="emailHelp" placeholder="Enter Made In Product..." style="width:85%">
                                    </div>
                                    ...
                                    <!--image-->
                                    <div class="form-group ">
                                        <img src="${d.imageURL}"  id="thumbnil" width="300dx" height="200px"/>

                                    </div>


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 10%; margin:auto">Choose image:</span>
                                        <input type="file" onchange="showMyImage(this)" class="form-control form-control-file" name="image" style="width:90%"/>
                                ...
                                <script type = "text/javascript">
                                    function validateForm() {
                                        ...
                                        var active = document.getElementById("prdIsActive").value;
                                        var changeNote = document.getElementById("noteIsAc").value;
                                        if (changeNote == "hasOrder" && active == "0") {
                                            alert("Cannot change Active");
                                            return false;
                                        }
                                        if (changeNote == "noneOrderHasCart" && active == "0") {

                                            var result = confirm("If click ok will delete all data in the cart!!");
