                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="subCateServlet?action=showPage">SubCategory</a>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight:bold">UPDATE DETAIL SUBCATEGORY</h1>
                                </div>

                                <form class="user" action="subCateServlet?action=update" method="POST">

                                    <div class="form-group">
                                        <input type="text" name="subID" value="${d.id}"hidden="true" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID SubCaterogy...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Subcategory name:</span><input type="text" name="subName" pattern=".{0,50}" value="${d.name}" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name SubCaterogy..." style="width:83%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Select category:</span>
                                        <select id="subCate" required="true" class="form-control" name="subCate" style="width:83%">
                                            <c:forEach items="${listCate}" var="row">       
                                                <c:choose>
                                                    <c:when test="${row.id==d.categoryId.id}">
                                                        <option id="${row.id}" value="${row.id}" selected="true" >${row.name}</option>
                                                    </c:when>  
