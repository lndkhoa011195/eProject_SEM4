                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="caterogyServlet?action=showPage">Category</a>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">UPDATE DETAIL CATEGORY</h1>
                                </div>

                                <form class="user" action="caterogyServlet?action=update" method="POST">

                                    <div class="form-group">
                                        <input type="text" name="cateID" value="${d.id}" hidden="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID Caterogy...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Category name:</span><input type="text" name="cateName" required="true" pattern=".{0,30}" value="${d.name}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Caterogy..." style="width:85%">
                                    </div>
