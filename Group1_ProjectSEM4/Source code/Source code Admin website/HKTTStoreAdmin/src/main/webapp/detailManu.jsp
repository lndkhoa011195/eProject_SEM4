                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="manufacturerServlet?action=showPage">Manufacturer</a>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">UPDATE DETAIL MANUFACTURER</h1>
                                </div>

                                <form class="user" action="manufacturerServlet?action=update" method="POST">

                                    <div class="form-group">
                                        <input type="text" name="manuID" value="${d.id}"hidden="true" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID Manafucturer...">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's name:</span><input type="text" name="manuName" value="${d.name}" pattern=".{0,50}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Manufucturer..." style="width: 80%">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's address:</span><input type="text" name="manuAddress" value="${d.address}" pattern=".{0,200}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Address Manafucturer..." style="width: 80%">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's email:</span><input type="email" name="manuEmail" value="${d.email}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Manafucturer..." style="width: 80%">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's phone:</span><input type="tel" name="manuPhone" value="${d.phone}" pattern="[0-9]{1}[1-9]{1}[0-9]{8,11}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Phone Manafucturer..." style="width: 80%">
                                    </div>
