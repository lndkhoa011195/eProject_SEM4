            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">${noteInsertManuPage}</h1>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT MANUFACTURER</h1>
                                </div>

                                <form class="user" action="manufacturerServlet?action=insert" method="POST">


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's name:</span><input type="text" name="manuName" pattern=".{0,50}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Manafucturer..." style="width: 80%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's address:</span><input type="text" name="manuAddress"  pattern=".{0,200}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Address Manafucturer..."style="width: 80%">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's email:</span><input type="email" name="manuEmail" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Manafucturer..." style="width: 80%"/>
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 20%; margin:auto">Manufacturer's phone:</span><input type="tel" name="manuPhone" pattern="[0-9]{1}[1-9]{1}[0-9]{8,11}" required="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Phone Manafucturer..." style="width: 80%">
                                    </div>
