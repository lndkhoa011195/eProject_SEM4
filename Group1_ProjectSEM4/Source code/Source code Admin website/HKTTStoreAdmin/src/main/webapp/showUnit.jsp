                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <a href="unitServlet?action=showInsert" style="witdh:200px;margin-bottom: 10px ;" class="btn btn-primary">Insert Unit</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="row">
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" onclick="return checkDelete()" href="unitServlet?action=delete&&code=${row.id}">Delete</a>
                                                        <a class="btn btn-success" href="unitServlet?action=detail&&code=${row.id}">Update</a>
                                    ...
                                    <script type = "text/javascript">
                                        function checkDelete() {
                                            ...
                                            var result = confirm("If click ok will delete Unit!!");
