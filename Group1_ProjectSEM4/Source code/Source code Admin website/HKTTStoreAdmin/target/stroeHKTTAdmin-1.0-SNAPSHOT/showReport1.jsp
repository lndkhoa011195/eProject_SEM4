        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseReport" class="collapse show" aria-labelledby="headingReport" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Report Management:</h6>
                            <a class="collapse-item active" href="reportServlet?action=showPage">Report 1</a>                            
                        </div>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-header">Top 10 sold product report</div>
                                <div class="card-body">
                                    <form action="MostSoldProduct.jsp" onsubmit = "return validateForm()">
                                        From <input type="date" id="date1" name="from1" required/>
                                        To <input id="date2" type="date" name="to1" required/>
                            ...
                            <div class="card">
                                <div class="card-header">Total product sold of year report</div>
                                <div class="card-body">
                                    <form action="totalPrice.jsp">
                                        <input type="number" name="currentY" min="2000" max="2099" step="1" value="2020" />
                                        <input class="btn btn-primary" type="submit" value="Show"/>
                                    </form>
                                </div> 
                            </div>
                            ...
                            <div class="card">
                                <div class="card-header">Top 10 Buyers Report</div>
                                <div class="card-body">
                                    <form action="CustomerReport.jsp">
                            ...
                            <div class="card">
                                <div class="card-header">Total Product By Category Report</div>
                                <div class="card-body">
                                    <form action="TotalProductByCategory.jsp">
