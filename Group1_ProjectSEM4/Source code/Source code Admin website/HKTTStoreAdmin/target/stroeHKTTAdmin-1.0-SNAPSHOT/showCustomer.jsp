                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                                                         <a href="customerServlet?action=showInsert" class="btn btn-primary" style="witdh:200px;margin-bottom: 10px ;">Insert Customer</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="row">
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" onclick="return checkDelete()" href="customerServlet?action=delete&&code=${row.id}">Delete</a>
                                                        <a class="btn btn-success" href="customerServlet?action=detail&&code=${row.id}">Update</a>
                                    ...
                                    <script type = "text/javascript">
                                        function checkDelete() {
                                            ...
                                            var result = confirm("If click ok will delete Customer!!");
