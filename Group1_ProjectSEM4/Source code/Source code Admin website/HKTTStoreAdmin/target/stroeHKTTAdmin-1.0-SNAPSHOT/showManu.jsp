                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">MANUFACTUTER LIST</h6>
                            </div>
                            <div class="card-body">
                           
                                <div class="table-responsive">
                                            <a href="manufacturerServlet?action=showInsert"  style="witdh:200px;margin-bottom: 10px ;" class="btn btn-primary">Insert Manufacturer</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="row">
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" onclick="return checkDelete()" href="manufacturerServlet?action=delete&&code=${row.id}">Delete</a>
                                                        <a class="btn btn-success" href="manufacturerServlet?action=detail&&code=${row.id}">Update</a>
                                    ...
                                    <script type = "text/javascript">
                                        function checkDelete() {
                                            ...
                                            var result = confirm("If click ok will delete Manufacturer!!");
