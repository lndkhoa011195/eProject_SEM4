                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="promotionServlet?action=showPage">Promotion</a>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">UPDATE ADS</h1>
                                </div>

                                <form class="user" action="promotionServlet?action=update" enctype="multipart/form-data" method="POST">

                                    
                                    <div class="form-group">
                                        <input type="text" name="proID" hidden="true" id="prdName" value="${d.id}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="prdName" disabled="true" id="prdName" value="${d.productId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">                                
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdCate" id="prdName" value="${d.productId.categoryId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdSubCate" id="prdName" value="${d.productId.subCategoryId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdManu" id="prdName" value="${d.productId.manufacturerId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdUnit" id="prdName" value="${d.productId.unitId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div> 



                                    <div class="form-group">
                                        <img src="${d.imageURL}"  id="thumbnil" width="200dx" height="100px"/>
