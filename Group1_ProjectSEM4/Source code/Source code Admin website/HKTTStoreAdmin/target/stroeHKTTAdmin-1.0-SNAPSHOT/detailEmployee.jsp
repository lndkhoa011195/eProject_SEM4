                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="employeeServlet?action=update" onsubmit = "return validateForm()" method="POST">

                                    <div class="form-group">
                                       <input type="text" name="empID" value="${d.id}" hidden="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID Employee...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Name:</span><input type="text"  style="width: 83%" name="empName" pattern="[a-zA-Z ]{0,50}" required="true" value="${d.name}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Employee...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Phone:</span><input type="text"  style="width: 83%"name="empPhone"  pattern="[0-9]{1}[1-9]{1}[0-9]{8,11}" required="true" value="${d.phone}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Phone Employee...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Email:</span><input type="email"  style="width: 83%" name="empEmail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="true" value="${d.email}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Employee...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Old password:</span><input type="password" style="width: 83%" id="empCurrentPass" name="empCurrentPass" required="true" value=""  class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Current Pass...">
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">New password:</span><input type="password"  style="width: 83%" id="empPass" name="empPass" required="true" value=""  class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Pass first...">
                                    </div>

                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 17%; margin:auto">Confirm password:</span><input type="password"  style="width: 83%" id="empPass2" name="empPass2" required="true" value="" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Pass Second...">
                                    </div>
                                ...
                                <script type = "text/javascript">
                                    function validateForm() {
                                        ...
                                        var pass2 = document.getElementById("empPass2").value;
