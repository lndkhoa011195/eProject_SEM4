                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT ADS</h1>
                                </div>

                                <form class="user" action="promotionServlet?action=insert" enctype="multipart/form-data" method="POST">

                                    <div class="form-group">
                                        <input type="text" name="prdID" hidden="true" id="prdName" value="${ds.id}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="prdName" disabled="true" id="prdName" value="${ds.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">                                
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdCate" id="prdName" value="${ds.categoryId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdSubCate" id="prdName" value="${ds.subCategoryId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdManu" id="prdName" value="${ds.manufacturerId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div>
                                    <div class="form-group">
                                        <input disabled="true" type="text" name="prdUnit" id="prdName" value="${ds.unitId.name}" class="form-control" id="prdName" aria-describedby="emailHelp" placeholder="Enter Name Product...">
                                    </div> 



                                    <div class="form-group">
                                        <img src=""  id="thumbnil" width="200dx" height="100px"/>
