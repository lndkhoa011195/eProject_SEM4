                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT CATEGORY</h1>
                                </div>

                                <form class="user" action="caterogyServlet?action=insert" method="POST">


                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 15%; margin:auto">Category name:</span><input type="text" name="cateName"  pattern=".{0,30}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Caterogy..." style="width:85%">
                                    </div>
