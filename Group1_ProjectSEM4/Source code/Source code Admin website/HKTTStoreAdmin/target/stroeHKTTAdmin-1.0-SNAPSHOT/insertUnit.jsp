            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">${noteInsertUnitPage}</h1>
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">INSERT UNIT</h1>
                                </div>

                                <form class="user" action="unitServlet?action=insert" method="POST">


                                   <div class="form-group row">
                                       <span style="font-weight: bold;width: 10%; margin:auto">Unit name:</span><input type="text" name="unitName" pattern=".{0,50}" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Unit..." style="width: 90%">
                                    </div>
