                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                       <a href="caterogyServlet?action=showInsert" class="btn btn-primary" style="witdh:200px;margin-bottom: 10px ;">Insert Category</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="row">
                                                <tr>
                                                    ...
                                                    <td><a class="btn btn-danger" onclick="return checkDelete()" href="caterogyServlet?action=delete&&code=${row.id}">Delete</a>
                                                        <a class="btn btn-success" href="caterogyServlet?action=detail&&code=${row.id}">Update</a>
