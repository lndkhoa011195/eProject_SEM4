                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="unitServlet?action=showPage">Unit</a> 
                        ...
                        <div class="container">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4" style="font-weight: bold">UPDATE DETAIL UNIT</h1>
                                </div>

                                <form class="user" action="unitServlet?action=update" method="POST">

                                    <div class="form-group row">
                                        <input type="text" name="unitID" value="${d.id}"hidden="true" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter ID Unit..." >
                                    </div>
                                    
                                    <div class="form-group row">
                                        <span style="font-weight: bold;width: 10%; margin:auto">Unit name:</span><input type="text" name="unitName"  pattern=".{0,50}" accept="" value="${d.name}"class="form-control" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Name Unit..."style="width:90%">
                                    </div>
