        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!helper.isValidEmail(etEmail.getText().toString())) {
                    Toast.makeText(ChangeInfoActivity.this, "Enter Valid Email Address", Toast.LENGTH_SHORT).show();
                } else if (!helper.validateLetters(etName.getText().toString())) {
                    Toast.makeText(ChangeInfoActivity.this, "Enter Valid Name", Toast.LENGTH_SHORT).show();
                } else if (!helper.validatePhone(etMobile.getText().toString())) {
                    Toast.makeText(ChangeInfoActivity.this, "Enter Valid Phone", Toast.LENGTH_SHORT).show();
                } else if (!helper.validateAddress(etAddress.getText().toString())) {
                    Toast.makeText(ChangeInfoActivity.this, "Enter Valid Address", Toast.LENGTH_SHORT).show();
                } else {
